...
public class MainActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_nt_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				SketchwareUtil.showMessage(getApplicationContext(), "connected to Server");
			}
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				dialog.setTitle("network checker...");
				dialog.setIcon(R.drawable.cigiyalogo);
				dialog.setMessage("this application requires internet connection, it seems you are not connected");
	...
	private void initializeLogic() {
		_check();
		button1.setOnTouchListener(new View.OnTouchListener(){  				@Override 				public boolean onTouch(View p1, MotionEvent p2) 				{ 					switch (p2.getAction()){  						case MotionEvent.ACTION_UP:  							button1.setScaleX(1.0f); 							button1.setScaleY(1.0f);  							break;  						case MotionEvent.ACTION_DOWN:  							button1.setScaleX(0.8f); 							button1.setScaleY(0.8f);  							break; 							 						case MotionEvent.ACTION_CANCEL:  							button1.setScaleX(1.0f); 							button1.setScaleY(1.0f);  							break; 							 				}  					return false; 			} 		});
		_style(button1);
				...
				t = new TimerTask() {
						...
						public void run() {
								runOnUiThread(new Runnable() {
										@Override
										public void run() {
												in.setClass(getApplicationContext(), AddActivity.class);
												startActivity(in);
										}
								});
						}
	...
	public void _style (final View _view) {
		android.graphics.drawable.GradientDrawable buttons = new android.graphics.drawable.GradientDrawable();
		 buttons.setColor(Color.parseColor("#03A9F4"));
		
		buttons.setCornerRadius(25); 
		
		buttons.setStroke(2, Color.parseColor("#FFFFFF"));
		_view.setBackground(buttons);
		_view.setElevation(10);
	}
	
	
	public void _check () {
		nt.startRequestNetwork(RequestNetworkController.GET, "http://google.com", "A", _nt_request_listener);
	}
